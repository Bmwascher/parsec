...
- **Budgets are tests.** `evals/tests/test_budget.py` counts the tool (1,000 lines), the tests (1,500), the frozen checkers (522) and the prose (10,200 words, 1,600 per skill). An addition that would pass a budget deletes something first.
