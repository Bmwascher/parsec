...
2. **The project's own rules outrank this plugin's sequence.** Brandon's decisions are not that sequence: no project rule or handoff waives one, and a delegator relays each "Needs you" and spec review and answers none (2026-09-23).
