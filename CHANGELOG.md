...
- The Sol lane names GPT-6 Sol and is the default codex lane; Astra is the alternate, by name at any time. The codex note records that a new id refused on an old CLI wants the update, not a new entitlement.
