...
- Post the summary after every round (every kind, a PASS included, and to a delegator too), without waiting for Brandon, as rendered Markdown in this shape; the tool prints the heading and counts lines, pasted as is (2026-09-23). Never put it inside a code block: a fenced table wraps into unreadable pipes on his phone (2026-09-23).
